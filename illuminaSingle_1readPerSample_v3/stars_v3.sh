...
R1=$(find "$scratch_dir/$Run/" -type f -name "${sample}.fastq.gz" | head -n 1)
...
###binSize of 50 is used becaseu expecting paired reads of length 50-150. This size is ideal to  provide smoother coverage 
...
#Added 6 Aug 2025 keep the STAR Log file with the data
