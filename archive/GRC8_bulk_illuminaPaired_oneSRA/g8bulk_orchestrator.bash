...
SCRIPT_DIR="/home/wdemos/STAR_RSEM_pipeline/GRC8_bulk_illuminaPaired_oneSRA"

LIB="${SCRIPT_DIR}/lib_v10.sh"
STEP1_SCRIPT="${SCRIPT_DIR}/run_G8pe1SRA2QC.sh"
STEP2_SCRIPT="${SCRIPT_DIR}/run_G8pe1RNApipeline.bash"

BASE_DATA_DIR="/home/wdemos/data/expression/GEO"

MAX_CONCURRENT_SMALL="${MAX_CONCURRENT_SMALL:-3}"
...
log "Starting bulk_orchestrator_v18 (hybrid mode)"
