...
if [ -f "$gene_file" ]; then
    ...
    if [ $? -ne 0 ]; then
        ...
        cat "${PRJdir}/${geo_accession}/log_files/bedsNjsons/${geo_accession}_gsort_error.log" >> "$log_file"
        exit 1
    fi
    ...
    if [ $? -ne 0 ]; then
        ...
        cat "${PRJdir}/${geo_accession}/log_files/bedsNjsons/${geo_accession}_gCHRsort_error.log" >> "$log_file"
        exit 1
    fi
