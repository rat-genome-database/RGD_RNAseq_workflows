...
#    sort -k1,1 -k2,2n -k3,3n "$chr0_filtered" > "$CHRsorted_file" 2>>"${Logdir}/${geo_accession}/${geo_accession}_CHRsort_error.log"
    sort -k1,1 -k2,2n -k3,3n "$chr0_filtered" > "$CHRsorted_file" 2>>"${PRJdir}/${geo_accession}/log_files/bedsNjsons/${geo_accession}_CHRsort_error.log"
...
#        cat "${Logdir}/${Run}/${geo_accession}_CHRsort_error.log" >> "$log_file"
        cat "${PRJdir}/${geo_accession}/log_files/bedsNjsons/${geo_accession}_CHRsort_error.log" >> "$log_file"
        exit 1
    fi
