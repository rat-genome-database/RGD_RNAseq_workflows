...
#        cat "${Logdir}/${geo_accession}/${geo_accession}_sort_error.log" >> "$log_file"
    ...
    # Filter out rows starting with "NW_" and TPM equal to 0
...
#        cat "${Logdir}/${geo_accession}/${geo_accession}_CHRsort_error.log" >> "$log_file"
