...
# no scratch dir references needed
# update to accommodate the updated SexConflict script
...
##################################
#sh "${SCRIPT_DIR}/ConflictedSampleReport_v5.sh" ${BIOProjectID}
baseDir="$baseDir" PRJdir="$PRJdir" sh "${SCRIPT_DIR}/ConflictedSampleReport_v5.sh" "${BIOProjectID}"
###################################
